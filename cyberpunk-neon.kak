...
face global mono "%opt{green}"
face global block "%opt{green}"
...
face global PrimarySelection "rgba:d7d7d599,rgba:711c9199"
face global SecondarySelection "rgba:0abdc699,rgba:133e7c99"
face global PrimaryCursor "+br@Default"
face global SecondaryCursor "%opt{background},%opt{white}+b"
face global PrimaryCursorEol "%opt{background},%opt{pink}+b"
face global SecondaryCursorEol "%opt{background},%opt{green}+b"
